...
<style type="text/css">
	.navbar { background: #4676B6 !important;}
	.navbar-inverse { height: 100px; padding-top:20px }
	.navbar-brand { font-weight: 800; font-size: 28px; }
	.navbar-inverse a { color: #ccc !important; }
	.navbar-inverse a:hover { background: #4676B6 !important; }
	.navbar-nav a { font-weight: 500; font-size: 20px; }
	.dropdown-menu { background: #4676B6; }
	.dropdown-menu.inverse { background: #4676B6; }
	.dropdown-menu.inverse a { font-weight: 300; font-size: 18px; color: #ccc; }
	...
	.navbar-wrapper .container { position: relative; top: 10px; left: 0; width:100%;}
	.container { width: 100%; }
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><span class="glyphicon glyphicon-list"></span> Program Management <b class="caret"></b></a>
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <span class="glyphicon glyphicon-search"></span> Observation Data Search <b class="caret"></b></a>
							<ul class="dropdown-menu inverse">
<!-- 							<li><a href="#river-search"> by River </a></li> -->
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <span class="glyphicon glyphicon-wrench"></span> Assessment <b class="caret"></b></a>
							<ul class="dropdown-menu inverse">
								<li><a href="#">M1-M8</a></li>
